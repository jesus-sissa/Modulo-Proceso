...
Public Class rpt_HojaTrabajo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Proceso.rpt_HojaTrabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_HojaTrabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_HojaTrabajo = New rpt_HojaTrabajo()
        rpt.Site = Me.Site
        Return rpt
    End Function
