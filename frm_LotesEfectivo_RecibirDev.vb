Public Class frm_LotesEfectivo_RecibirDev

    Private Sub frm_LotesEfectivo_RecibirDev_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_Recibir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Recibir.Click
        ...
        If firma.Firma Then
            ...
            '----verificar si existe el lote a Recibir status='DV'
            For Each lotesVer As ListViewItem In Lsv_Efectivo.CheckedItems
                If Not Cn_Proceso.fn_LoteEfectivo_Verificar(lotesVer.Tag, "DV") Then
                ...
                End If
            Next
            ''-----Recibir lotes efectivo devueltos
            If Cn_Proceso.fn_LotesEfectivo_Status(Lsv_Efectivo, "A") Then
                MsgBox("Lotes devueltos Aceptados correctamente", MsgBoxStyle.Information, frm_MENU.Text)
            Else
    ...
    Private Sub LlenaLista()
        ...
        If Not Cn_Proceso.fn_CancelaEnvioEfectivoLlenalista(Lsv_Efectivo, cmb_CajaBancaria.SelectedValue, cmb_Destino.SelectedValue, "DV") Then
