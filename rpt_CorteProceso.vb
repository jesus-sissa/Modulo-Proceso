...
Public Class rpt_CorteProceso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Proceso.rpt_CorteProceso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_CorteProceso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_CorteProceso = New rpt_CorteProceso()
        rpt.Site = Me.Site
        Return rpt
    End Function
