...
Public Class OrdenDotacionesClientes
    ...
    Public Overrides Function GetDotaciones() As DataTable
        Dim Dotaciones = From DT As ds_Banorte.DotacionesRow In dsBanorte.Dotaciones _
                         ...
                         Where DT.ODES.StartsWith(CrCajaBancaria) _
                         Select DT.ID_DOTACION, DT.ODES, DT.ID_MOVIMIENTO, DT.ID_CLIENTE, DT.NUMERO_CUENTA, TS.TipoSolicitud, DT.ID_PROVEEDOR, DT.FECHA_SOLICITUD, DT.ID_TIPOSOLICITUD, OA.Archivo, OA.NumeroOrden, DT.REFERENCIA
        ...
        For Each item In Dotaciones
            ...
            dr("NumeroCuenta") = item.NUMERO_CUENTA
            dr("TipoSolicitud") = item.TipoSolicitud
            dr("IDProveedor") = item.ID_PROVEEDOR
    ...
    Protected Overrides Sub SetColumnas()
        ...
        dt_Dotaciones.Columns.Add("NumeroCuenta")
        dt_Dotaciones.Columns.Add("TipoSolicitud")
        dt_Dotaciones.Columns.Add("IDProveedor")
        ...
        dt_Dotaciones.Columns.Add("Referencia")
