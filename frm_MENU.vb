...
Public Class frm_MENU
    ...
    Private Sub ClientesInternosExternosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ClientesInternosExternosToolStripMenuItem.Click
        'Inicializar la variable de desconexion
        SegundosDesconexion = 0
        'Validar la Sesion
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
        ...
        End If
        'Insertar en Usr_Log
        Cn_Login.fn_Log_Create("ABRIR VENTANA: CATALOGO DE CLIENTES INTERNOS A EXTERNOS")

        Dim Frm As New Frm_ClientesInternosAExternos
        MostrarVentana(Frm, True)
    End Sub

    Private Sub EmpleadosQueCancelanDespachosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EmpleadosQueCancelanDespachosToolStripMenuItem.Click
        SegundosDesconexion = 0
        'Validar la Sesion
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        ...
        Dim frm As New frm_EmpleadosCancelanDespachos
        FuncionesGlobales.MostrarVentana(frm, False)
    End Sub

    Private Sub MonitoreoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MonitoreoToolStripMenuItem.Click
        SegundosDesconexion = 0
        'Validar la Sesion
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        ...
        Dim frm As New Frm_MonitoreoP
        frm.ShowDialog()
        'FuncionesGlobales.MostrarVentana(frm, False)
    End Sub

    Private Sub ConsultaDeImportesPorRecoleccionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConsultaDeImportesPorRecoleccionToolStripMenuItem.Click
        SegundosDesconexion = 0
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        End If
        Cn_Login.fn_Log_Create("ABRIR VENTANA: IMPORTES POR RECOLECCION")


        Dim frm As New frm_ImportesPorRecoleecciones
        FuncionesGlobales.MostrarVentana(frm, True)
    End Sub
End Class
