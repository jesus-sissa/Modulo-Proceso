...
Public Class rpt_Denominaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Proceso.rpt_Denominaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Denominaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Denominaciones = New rpt_Denominaciones
        rpt.Site = Me.Site
        Return rpt
    End Function
