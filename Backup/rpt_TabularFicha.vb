...
Public Class rpt_TabularFicha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Proceso.rpt_TabularFicha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_TabularFicha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_TabularFicha = New rpt_TabularFicha
        rpt.Site = Me.Site
        Return rpt
    End Function
