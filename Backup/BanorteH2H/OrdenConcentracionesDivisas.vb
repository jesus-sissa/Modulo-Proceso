...
Public Class OrdenConcentracionesDivisas
    ...
    Public Overrides Function GetDotaciones() As DataTable
        ...
        Dim Dotaciones = From DT As ds_Banorte.DotacionesRow In dsBanorte.Dotaciones _
                         ...
                         Select DT.ID_DOTACION, DT.ODES, DT.ID_CR, DT.ID_MOVIMIENTO, DT.ID_PROVEEDORPROCESO, DT.ID_PROVEEDORTRASLADO, DT.FECHA_SOLICITUD, OA.Archivo, OA.NumeroOrden, TS.TipoSolicitud, DT.ID_TIPOSOLICITUD
    ...
    Public Overrides Function GetDotacionesD(ByVal Id_Dota As Integer) As DataTable
        ...
        Dim DotacionesD = From DD As ds_Banorte.DotacionesDRow In dsBanorte.DotacionesD _
                          ...
                          Select DI.Divisa, TD.TipoDivisa, DD.Denominacion, DD.Cantidad, DD.Importe, DD.ID_Divisa, DD.ID_TipoDivisa, DD.Id_Denominacion, DD.Id_Dotacion
    ...
    Protected Sub setDotaciones(ByVal Valor As String, ByVal NombreNodo As String, ByRef dr As ds_Banorte.DotacionesRow)
        Select Case NombreNodo.ToUpper()
            ...
            Case "FECHA_ATENCION"
                dr.FECHA_SOLICITUD = Valor
            Case "ID_TIPOSOLICITUD"
                dr.ID_TIPOSOLICITUD = Valor
        End Select
    End Sub

    Protected Sub setDotacionesD(ByVal IdDotacion As Integer, ByVal Valor As String, ByVal NombreNodo As String, ByRef dr As ds_Banorte.DotacionesDRow)
