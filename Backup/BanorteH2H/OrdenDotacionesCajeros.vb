...
Public Class OrdenDotacionesCajeros
    ...
    Public Overrides Function GetDotaciones() As DataTable
        ...
        Dim Dotaciones = From DT As ds_Banorte.DotacionesRow In dsBanorte.Dotaciones _
                         ...
                         Join TD As ds_Banorte.TipoDotacionRow In dsBanorte.TipoDotacion On TD.Id_DotacionT Equals DT.ID_TIPODOTACION _
                         Where DT.ID_CR = CrCajaBancaria _
                         Select DT.ID_DOTACION, DT.ODES, DT.ID_CR, TD.TipoDotacion, TS.TipoSolicitud, DT.ID_PROVEEDOR, DT.ID_NEMONICO, DT.FECHA_ATENCION, OA.Archivo, OA.NumeroOrden, DT.ID_TIPODOTACION, DT.ID_TIPOSOLICITUD
