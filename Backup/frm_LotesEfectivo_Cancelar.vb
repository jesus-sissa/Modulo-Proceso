Public Class frm_LotesEfectivo_Cancelar

    Private Sub frm_LotesEfectivo_Cancelar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_Cancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Cancelar.Click
        ...
        If firma.Firma Then
            ...
            '----verificar si existe el lote a cancelar
            ...
            Next
            ''-----Cancelar lotes
            If Cn_Proceso.fn_CancelaEnvioEfectivoProceso(Lsv_Efectivo) Then
    ...
    Private Sub LlenaLista()
        ...
        btn_Cancelar.Enabled = False
        btn_Validar.Enabled = False
        btn_Validar.Visible = (cmb_Destino.SelectedValue = "25")
    ...
    Private Sub btn_Validar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Validar.Click
        ...
        If firma.Firma Then
            ...
            '----verificar si existe el lote a Validar
            For Each lotesVer As ListViewItem In Lsv_Efectivo.CheckedItems
                If Not Cn_Proceso.fn_LoteEfectivo_Verificar(lotesVer.Tag, "A") Then
                    MsgBox("Algunos de los lotes ya no esta disponibles. Es posible que ya se hayan recivido o cancelado desde otra estación de trabajo, se actualizará la lista.", MsgBoxStyle.Critical, frm_MENU.Text)
                    Call LlenaLista()
                    Exit Sub
                End If
            Next
            ...
            '-----Validar lotes
            If Cn_Proceso.fn_Validar_CancelacionEnvioEfectivoOtros(Lsv_Efectivo, UsuarioRecibe) Then
                MsgBox("Registros validados correctamente.", MsgBoxStyle.Information, frm_MENU.Text)
                Call LlenaLista()
            Else
                MsgBox("Ocurrió un error al validar los lotes.", MsgBoxStyle.Critical, frm_MENU.Text)
            End If
