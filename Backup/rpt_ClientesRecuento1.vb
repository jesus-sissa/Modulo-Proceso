...
Public Class rpt_ClientesRecuento
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_ClientesRecuento.rpt"
        End Get
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Proceso.rpt_ClientesRecuento.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
...
Public Class Cachedrpt_ClientesRecuento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ClientesRecuento = New rpt_ClientesRecuento
        rpt.Site = Me.Site
        Return rpt
    End Function
