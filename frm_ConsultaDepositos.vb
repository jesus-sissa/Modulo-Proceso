...
Public Class frm_ConsultaDepositos
    ...
    Private Sub LlenarLista()
        ...
        If Validar() Then
            ...
            TipoConsulta = "S"
            If Not fn_ConsultaDepositos_LlenarRemisiones(lsv_Dotaciones, cmb_CajaBancaria.SelectedValue, TipoConsulta, dtp_Desde.Value, dtp_Hasta.Value,
                                                   cmb_Desde.SelectedValue, cmb_Hasta.SelectedValue, cmb_Status.SelectedValue,
                                                   Corte, cmb_Clientes.SelectedValue, cmb_Cajero.SelectedValue, Datos) Then
    ...
    Private Function Validar() As Boolean
        ...
        If cmb_CajaBancaria.SelectedValue = "0" And Not cbx_caja.Checked Then
        ...
        If cmb_Clientes.SelectedValue = "0" And Not cbx_Clientes.Checked Then
            ...
            Return False
        End If
        If cmb_Cajero.SelectedValue = "0" And Not cbx_cajero.Checked Then
    ...
    Private Sub btn_Exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Exportar.Click
        ...
        'Dim Reporte As New Excel
        ' Reporte.ExportarExcel(Datos, frm_MENU.prg_Barra)
        'Dim t1 As Task = Task.Run(Sub()
        '                              'Dim Tbol As Task(Of Boolean) = FuncionesGlobales.fn_Exportar_Excel(lsv_Dotaciones, 2, "CONSULTA DE DEPOSITOS", 0, 1, frm_MENU.prg_Barra)
        '                              Dim Tbol As Task(Of Boolean) = Reporte.ExportarExcel(Datos, frm_MENU.prg_Barra)
        '                          End Sub)

        't1.GetAwaiter().GetResult()
        'Dim task As New Task(Of String)(llamada)
        'task.Start()
        'Await task 
        'Dim task As Task = New Task(New Action(AddressOf llamada))
        'task.Start()
        'Await task
    End Sub
    Sub llamada()
    ...
    Private Sub Btn_Desbloquear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Desbloquear.Click
        ...
        Btn_Desbloquear.Visible = False
        Me.Refresh()
        If Fn_ConsultaDepositos_Desbloqueo(lsv_Dotaciones.SelectedItems(0).SubItems(13).Text, "IN") = False Then
    ...
    Private Sub cbx_caja_CheckedChanged(sender As Object, e As EventArgs) Handles cbx_caja.CheckedChanged
        Call Limpiar()
        cmb_CajaBancaria.Enabled = Not cbx_caja.Checked
        If cbx_caja.Checked Then
            cmb_CajaBancaria.SelectedValue = "0"
        End If
    End Sub

    Private Sub cbx_cajero_CheckedChanged(sender As Object, e As EventArgs) Handles cbx_cajero.CheckedChanged
        Call Limpiar()
        cmb_Cajero.Enabled = Not cbx_cajero.Checked
        If cbx_cajero.Checked Then
